		...
		$("#username").blur(
			function() {
				...
				function checkUsername() {
					var usernameFormat = new RegExp("^[\u4E00-\u9fA5a-zA-Z0-9_]{4,16}$");
					if ($(thisSelf).val() == "" || $(thisSelf).val() == " ") {
						...
						$.post("userRegister!getUserState.action",
							{
								username : $(thisSelf).val()
							},
							function(data) {
								//alert("userState");
								if (data == "isExist") {
...
<body>
<div id="registerDiv">
	<form action="userRegister!registerUser" method="post" id="registerForm">
