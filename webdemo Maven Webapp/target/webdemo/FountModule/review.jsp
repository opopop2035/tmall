...
<html>
  ...
  <body>
    ...
    <div class="reviewProductInfoDiv">
        <div class="reviewProductInfoImg"><img width="400px" height="400px" src="FountModule/img/productSingle/${p.firstProductImage.id}.jpg"></div>
        <div class="reviewProductInfoRightDiv">
            ...
            <div class="reviewProductInfoRightBelowDiv">
                <span class="reviewProductInfoRightBelowImg"><img src="FountModule/img/site/reviewLight.png"></span>
                <span class="reviewProductInfoRightBelowText" >现在查看的是 您所购买商品的信息于<fmt:formatDate value="${o.createTime}" pattern="yyyy年MM月dd"/>下单购买了此商品 </span>
            </div>
        </div>
