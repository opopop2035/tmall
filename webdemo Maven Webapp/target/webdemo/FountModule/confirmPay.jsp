...
<%
String confirmpaypath = request.getContextPath();
String confirmpaybasePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+confirmpaypath+"/";
%>

<!DOCTYPE html>
<html>
  <head>
    <base href="<%=confirmpaybasePath%>">
  ...
  <div class="confirmPayPageDiv">
    <div class="confirmPayImageDiv">
        <img src="FountModule/img/site/comformPayFlow.png">
    ...
    <div class="confirmPayOrderItemDiv">
        ...
        <table class="confirmPayOrderItemTable">
            ...
            <tr>
                ...
                <th style="width: 120px;">商品总价 </th>        
                <th style="width: 120px;">运费</th>       
            </tr>
            </thead>
            <c:forEach items="${o.orderItems}" var="oi">
                <tr>
                    <td><img width="50px" src="FountModule/img/productSingle_middle/${oi.product.firstProductImage.id}.jpg"></td>
                    ...
                    <td>1</td>
                    <td><span class="conformPayProductPrice">￥<fmt:formatNumber type="number" value="${oi.product.barginPrice}" minFractionDigits="2"/></span></td>
    ...
    <div class="confirmPayOrderDetailDiv">
        ...
        <table class="confirmPayOrderDetailTable">
            <tr>
                <td>订单编号：</td>
                <td>${o.orderCode} <img width="23px" src="FountModule/img/site/confirmOrderTmall.png"></td>
            </tr>
            <tr>
                <td>卖家昵称：</td>
            ...
            <tr>
                <td>收货信息： </td>
                <td>${o.address}，${o.receiver}， ${o.mobile}，${o.postcode} </td>
            </tr>
            <tr>
                <td>成交时间：</td>
